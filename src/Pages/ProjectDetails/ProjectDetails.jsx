            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-1 sm:space-x-4">
                ...
                <nav className="text-sm text-gray-500 dark:text-gray-400">
                  <Link
                    to="/portfolio"
                    className="hover:text-blue-600 dark:hover:text-blue-400 text-[12px] md:text-[14px] lg:text-[16px]"
                  >
                    Portfolio
                  </Link>
                  <span className="mx-2">/</span>
                  <span className="text-gray-900 dark:text-white sm:font-medium text-[12px] md:text-[14px] lg:text-[16px] ">
                    {project.title}
                  </span>
                </nav>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                <div className="space-y-6">
                  <div>
                    <h1 className="text-[16px] md:text-[24px] font-bold text-gray-900 dark:text-white mb-4">
                      {project.title}
                    </h1>
